...
- `docs/reports/HOOKS_NOTIFICATIONS_GATE.md` records the boundaries that still block broader hook editing, hook execution, test-payload execution, OS notifications, quiet mode, and runtime-integrated readiness notifications.
