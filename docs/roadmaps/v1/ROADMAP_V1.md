...
- Add restrained page transitions, panel slide-ins, loading skeletons, and resize-to-collapse. The existing right-inspector drag-to-collapse path is now discoverable and validated in Browser and Electron; page transitions, slide-ins, and loading skeletons remain planned.
