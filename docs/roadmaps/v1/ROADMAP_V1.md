...
- Add fuzzy search over commands, settings, projects, sessions, agents, skills, docs, and recent workflows. Implemented for commands, workflow recipes, and Settings sections; project/session/docs search remains planned.
