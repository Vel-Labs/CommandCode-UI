...
- Add restrained page transitions, panel slide-ins, loading skeletons, and resize-to-collapse. Implemented so far for right-inspector grid easing, slide/fade entry motion, and discoverable drag-to-collapse; loading skeletons remain planned.
